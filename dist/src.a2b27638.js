...
function enterNumber() {
  return new Promise(function (resolve, reject) {
    var userNumber = Number(window.prompt("Enter a number between 1-6: "));
...
function playGame() {
  enterNumber().then(function (result) {
    alert("Random Number: ".concat(result.randomNumber, ", your score: ").concat(result.points));
    continuePlaying().then(function (result) {
      if (result) {
        playGame();
      } else {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "46367" + '/');
